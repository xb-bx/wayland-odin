...
xdg_wm_base_add_listener :: proc(
	...
	return proxy_add_listener(cast(^wl_proxy)xdg_wm_base, auto_cast listener, data)
}
...
xdg_wm_base_events: []wl_message = []wl_message{{"ping", "u", nil}}

xdg_wm_base_interface: wl_interface = {}
@(init)
init_xdg_wm_base_interface :: proc() {
...
xdg_positioner_add_listener :: proc(
	...
	return proxy_add_listener(cast(^wl_proxy)xdg_positioner, auto_cast listener, data)
}
...
xdg_positioner_set_size :: proc "c" (
	_xdg_positioner: ^xdg_positioner,
	width: c.int32_t,
	height: c.int32_t,
) {
	proxy_marshal_flags(
...
xdg_positioner_set_anchor_rect :: proc "c" (
	_xdg_positioner: ^xdg_positioner,
	x: c.int32_t,
	y: c.int32_t,
	width: c.int32_t,
...
xdg_positioner_set_constraint_adjustment :: proc "c" (
	_xdg_positioner: ^xdg_positioner,
...
xdg_positioner_set_offset :: proc "c" (
	_xdg_positioner: ^xdg_positioner,
	x: c.int32_t,
	y: c.int32_t,
) {
...
xdg_positioner_set_parent_size :: proc "c" (
	_xdg_positioner: ^xdg_positioner,
	parent_width: c.int32_t,
...
xdg_positioner_set_parent_configure :: proc "c" (
	_xdg_positioner: ^xdg_positioner,
	serial: c.uint32_t,
) {
	proxy_marshal_flags(
...
@(init)
init_xdg_positioner_interface :: proc() {
...
xdg_surface_add_listener :: proc(
	...
	return proxy_add_listener(cast(^wl_proxy)xdg_surface, auto_cast listener, data)
}
...
xdg_surface_events: []wl_message = []wl_message{{"configure", "u", nil}}

xdg_surface_interface: wl_interface = {}
@(init)
init_xdg_surface_interface :: proc() {
	xdg_surface_interface = {
		"xdg_surface",
		6,
		5,
...
xdg_toplevel_add_listener :: proc(
	...
	return proxy_add_listener(cast(^wl_proxy)xdg_toplevel, auto_cast listener, data)
}
...
@(init)
init_xdg_toplevel_interface :: proc() {
	xdg_toplevel_interface = {
		"xdg_toplevel",
		6,
		14,
...
xdg_popup_listener :: struct {
	...
	popup_done:   proc "c" (data: rawptr, xdg_popup: ^xdg_popup),
	repositioned: proc "c" (data: rawptr, xdg_popup: ^xdg_popup, token: c.uint32_t),
}
...
xdg_popup_add_listener :: proc(
	...
	return proxy_add_listener(cast(^wl_proxy)xdg_popup, auto_cast listener, data)
}
...
xdg_popup_reposition :: proc "c" (
	_xdg_popup: ^xdg_popup,
	positioner: ^xdg_positioner,
	token: c.uint32_t,
) {
	proxy_marshal_flags(
