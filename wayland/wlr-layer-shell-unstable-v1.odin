...
zwlr_layer_shell_v1_add_listener :: proc(
	...
	return proxy_add_listener(
		cast(^wl_proxy)zwlr_layer_shell_v1,
...
zwlr_layer_shell_v1_get_layer_surface :: proc "c" (
	...
	id = proxy_marshal_flags(
		...
		proxy_get_version(cast(^wl_proxy)_zwlr_layer_shell_v1),
		0,
		nil,
		surface,
		output,
...
zwlr_layer_surface_v1_listener :: struct {
	...
	closed:    proc "c" (data: rawptr, zwlr_layer_surface_v1: ^zwlr_layer_surface_v1),
}
...
zwlr_layer_surface_v1_add_listener :: proc(
	...
	return proxy_add_listener(
		cast(^wl_proxy)zwlr_layer_surface_v1,
		cast(^Implementation)listener,
		data,
	)
}

zwlr_layer_surface_v1_set_size :: proc "c" (
	_zwlr_layer_surface_v1: ^zwlr_layer_surface_v1,
	width: c.uint32_t,
	height: c.uint32_t,
) {
	proxy_marshal_flags(
		...
		0,
		nil,
		proxy_get_version(cast(^wl_proxy)_zwlr_layer_surface_v1),
		0,
		width,
		height,
	)
...
zwlr_layer_surface_v1_set_anchor :: proc "c" (
	_zwlr_layer_surface_v1: ^zwlr_layer_surface_v1,
	anchor: c.uint32_t,
) {
	proxy_marshal_flags(
...
zwlr_layer_surface_v1_set_exclusive_zone :: proc "c" (
	_zwlr_layer_surface_v1: ^zwlr_layer_surface_v1,
	zone: c.int32_t,
) {
	proxy_marshal_flags(
...
zwlr_layer_surface_v1_set_margin :: proc "c" (
	_zwlr_layer_surface_v1: ^zwlr_layer_surface_v1,
	top: c.int32_t,
	right: c.int32_t,
	bottom: c.int32_t,
...
zwlr_layer_surface_v1_set_keyboard_interactivity :: proc "c" (
	_zwlr_layer_surface_v1: ^zwlr_layer_surface_v1,
	keyboard_interactivity: c.uint32_t,
) {
	proxy_marshal_flags(
		cast(^wl_proxy)_zwlr_layer_surface_v1,
		4,
...
zwlr_layer_surface_v1_get_popup :: proc "c" (
	_zwlr_layer_surface_v1: ^zwlr_layer_surface_v1,
	popup: ^xdg_popup,
) {
	proxy_marshal_flags(
...
zwlr_layer_surface_v1_ack_configure :: proc "c" (
	_zwlr_layer_surface_v1: ^zwlr_layer_surface_v1,
	serial: c.uint32_t,
) {
	proxy_marshal_flags(
...
zwlr_layer_surface_v1_set_layer :: proc "c" (
	_zwlr_layer_surface_v1: ^zwlr_layer_surface_v1,
	layer: c.uint32_t,
) {
	proxy_marshal_flags(
...
zwlr_layer_surface_v1_set_exclusive_edge :: proc "c" (
	_zwlr_layer_surface_v1: ^zwlr_layer_surface_v1,
	edge: c.uint32_t,
) {
	proxy_marshal_flags(
