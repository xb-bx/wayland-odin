...
wl_data_offer_set_actions :: proc(
	_wl_data_offer: ^wl_data_offer,
...
wl_data_device_start_drag :: proc(
...
wl_data_device_set_selection :: proc(
	_wl_data_device: ^wl_data_device,
	source: ^wl_data_source,
	serial: c.uint32_t,
) {
...
wl_data_device_manager_create_data_source :: proc(
...
wl_data_device_manager_get_data_device :: proc(
	_wl_data_device_manager: ^wl_data_device_manager,
	seat: ^wl_seat,
) -> ^wl_data_device {
	id: ^wl_proxy
...
wl_shell_get_shell_surface :: proc(
	_wl_shell: ^wl_shell,
	surface: ^wl_surface,
) -> ^wl_shell_surface {
	id: ^wl_proxy
...
wl_shell_surface_set_transient :: proc(
	_wl_shell_surface: ^wl_shell_surface,
	parent: ^wl_surface,
	x: c.int32_t,
	y: c.int32_t,
...
wl_shell_surface_set_fullscreen :: proc(
	_wl_shell_surface: ^wl_shell_surface,
	method: c.uint32_t,
...
wl_shell_surface_set_popup :: proc(
	_wl_shell_surface: ^wl_shell_surface,
	seat: ^wl_seat,
	serial: c.uint32_t,
	parent: ^wl_surface,
...
wl_touch_listener :: struct {
	...
	orientation: proc(data: rawptr, wl_touch: ^wl_touch, id: c.int32_t, orientation: wl_fixed_t),
}
...
wl_subcompositor_get_subsurface :: proc(
