...
create_wl_display :: proc "contextless" (proxy: ^wl_proxy) -> ^WlDisplay {
	...
	callback = proxy_marshal_flags(
                self.proxy,
		        0, &wl_callback_interface, proxy_get_version(self.proxy), 0, nil);
	...
	registry = proxy_marshal_flags(
                self.proxy,
		        1, &wl_registry_interface, proxy_get_version(self.proxy), 0, nil);
...
create_wl_compositor :: proc "contextless" (proxy: ^wl_proxy) -> ^WlCompositor {
	...
	id = proxy_marshal_flags(
                self.proxy,
		        0, &wl_surface_interface, proxy_get_version(self.proxy), 0, nil);
	...
	id = proxy_marshal_flags(
                self.proxy,
		        1, &wl_region_interface, proxy_get_version(self.proxy), 0, nil);
...
create_wl_shm_pool :: proc "contextless" (proxy: ^wl_proxy) -> ^WlShmPool {
	...
	id = proxy_marshal_flags(
                self.proxy,
		        0, &wl_buffer_interface, proxy_get_version(self.proxy), 0, nil, offset, width, height, stride, format);
    ...
    destroy := proc "c" (
        ...
        proxy_marshal_flags(
                self.proxy,
		        1, nil, proxy_get_version(self.proxy), WL_MARSHAL_FLAG_DESTROY);
    ...
    resize := proc "c" (
        ...
        proxy_marshal_flags(
                self.proxy,
		        2, nil, proxy_get_version(self.proxy), 0, size);
...
create_wl_shm :: proc "contextless" (proxy: ^wl_proxy) -> ^WlShm {
	...
	id = proxy_marshal_flags(
                self.proxy,
		        0, &wl_shm_pool_interface, proxy_get_version(self.proxy), 0, nil, fd, size);
...
create_wl_buffer :: proc "contextless" (proxy: ^wl_proxy) -> ^WlBuffer {
    ...
    destroy := proc "c" (
        ...
        proxy_marshal_flags(
                self.proxy,
		        0, nil, proxy_get_version(self.proxy), WL_MARSHAL_FLAG_DESTROY);
...
create_wl_data_offer :: proc "contextless" (proxy: ^wl_proxy) -> ^WlDataOffer {
    ...
    accept := proc "c" (
        ...
        proxy_marshal_flags(
                self.proxy,
		        0, nil, proxy_get_version(self.proxy), 0, serial, mime_type);
    ...
    receive := proc "c" (
        ...
        proxy_marshal_flags(
                self.proxy,
		        1, nil, proxy_get_version(self.proxy), 0, mime_type, fd);
    ...
    destroy := proc "c" (
        ...
        proxy_marshal_flags(
                self.proxy,
		        2, nil, proxy_get_version(self.proxy), WL_MARSHAL_FLAG_DESTROY);
    ...
    finish := proc "c" (
        ...
        proxy_marshal_flags(
                self.proxy,
		        3, nil, proxy_get_version(self.proxy), 0);
    ...
    set_actions := proc "c" (
        ...
        proxy_marshal_flags(
                self.proxy,
		        4, nil, proxy_get_version(self.proxy), 0, dnd_actions, preferred_action);
...
create_wl_data_source :: proc "contextless" (proxy: ^wl_proxy) -> ^WlDataSource {
    ...
    offer := proc "c" (
        ...
        proxy_marshal_flags(
                self.proxy,
		        0, nil, proxy_get_version(self.proxy), 0, mime_type);
    ...
    set_actions := proc "c" (
        ...
        proxy_marshal_flags(
                self.proxy,
		        2, nil, proxy_get_version(self.proxy), 0, dnd_actions);
...
create_wl_data_device :: proc "contextless" (proxy: ^wl_proxy) -> ^WlDataDevice {
    ...
    start_drag := proc "c" (
        ...
        proxy_marshal_flags(
                self.proxy,
		        0, nil, proxy_get_version(self.proxy), 0, source, origin, icon, serial);
    ...
    set_selection := proc "c" (
        ...
        proxy_marshal_flags(
                self.proxy,
		        1, nil, proxy_get_version(self.proxy), 0, source, serial);
...
create_wl_data_device_manager :: proc "contextless" (proxy: ^wl_proxy) -> ^WlDataDeviceManager {
	...
	id = proxy_marshal_flags(
                self.proxy,
		        0, &wl_data_source_interface, proxy_get_version(self.proxy), 0, nil);
	...
	id = proxy_marshal_flags(
                self.proxy,
		        1, &wl_data_device_interface, proxy_get_version(self.proxy), 0, nil, seat);
...
create_wl_shell :: proc "contextless" (proxy: ^wl_proxy) -> ^WlShell {
	...
	id = proxy_marshal_flags(
                self.proxy,
		        0, &wl_shell_surface_interface, proxy_get_version(self.proxy), 0, nil, surface);
...
create_wl_shell_surface :: proc "contextless" (proxy: ^wl_proxy) -> ^WlShellSurface {
    ...
    pong := proc "c" (
        ...
        proxy_marshal_flags(
                self.proxy,
		        0, nil, proxy_get_version(self.proxy), 0, serial);
    ...
    move := proc "c" (
        ...
        proxy_marshal_flags(
                self.proxy,
		        1, nil, proxy_get_version(self.proxy), 0, seat, serial);
    ...
    resize := proc "c" (
        ...
        proxy_marshal_flags(
                self.proxy,
		        2, nil, proxy_get_version(self.proxy), 0, seat, serial, edges);
    ...
    set_transient := proc "c" (
        ...
        proxy_marshal_flags(
                self.proxy,
		        4, nil, proxy_get_version(self.proxy), 0, parent, x, y, flags);
    ...
    set_fullscreen := proc "c" (
        ...
        proxy_marshal_flags(
                self.proxy,
		        5, nil, proxy_get_version(self.proxy), 0, method, framerate, output);
    ...
    set_popup := proc "c" (
        ...
        proxy_marshal_flags(
                self.proxy,
		        6, nil, proxy_get_version(self.proxy), 0, seat, serial, parent, x, y, flags);
    ...
    set_maximized := proc "c" (
        ...
        proxy_marshal_flags(
                self.proxy,
		        7, nil, proxy_get_version(self.proxy), 0, output);
    ...
    set_title := proc "c" (
        ...
        proxy_marshal_flags(
                self.proxy,
		        8, nil, proxy_get_version(self.proxy), 0, title);
    ...
    set_class := proc "c" (
        ...
        proxy_marshal_flags(
                self.proxy,
		        9, nil, proxy_get_version(self.proxy), 0, class_);
...
create_wl_surface :: proc "contextless" (proxy: ^wl_proxy) -> ^WlSurface {
    ...
    attach := proc "c" (
        ...
        proxy_marshal_flags(
                self.proxy,
		        1, nil, proxy_get_version(self.proxy), 0, buffer, x, y);
    ...
    damage := proc "c" (
        ...
        proxy_marshal_flags(
                self.proxy,
		        2, nil, proxy_get_version(self.proxy), 0, x, y, width, height);
	...
	callback = proxy_marshal_flags(
                self.proxy,
		        3, &wl_callback_interface, proxy_get_version(self.proxy), 0, nil);
    ...
    set_opaque_region := proc "c" (
        ...
        proxy_marshal_flags(
                self.proxy,
		        4, nil, proxy_get_version(self.proxy), 0, region);
    ...
    set_input_region := proc "c" (
        ...
        proxy_marshal_flags(
                self.proxy,
		        5, nil, proxy_get_version(self.proxy), 0, region);
    ...
    commit := proc "c" (
        ...
        proxy_marshal_flags(
                self.proxy,
		        6, nil, proxy_get_version(self.proxy), 0);
    ...
    set_buffer_transform := proc "c" (
        ...
        proxy_marshal_flags(
                self.proxy,
		        7, nil, proxy_get_version(self.proxy), 0, transform);
    ...
    set_buffer_scale := proc "c" (
        ...
        proxy_marshal_flags(
                self.proxy,
		        8, nil, proxy_get_version(self.proxy), 0, scale);
    ...
    damage_buffer := proc "c" (
        ...
        proxy_marshal_flags(
                self.proxy,
		        9, nil, proxy_get_version(self.proxy), 0, x, y, width, height);
    ...
    offset := proc "c" (
        ...
        proxy_marshal_flags(
                self.proxy,
		        10, nil, proxy_get_version(self.proxy), 0, x, y);
...
create_wl_seat :: proc "contextless" (proxy: ^wl_proxy) -> ^WlSeat {
	...
	id = proxy_marshal_flags(
                self.proxy,
		        0, &wl_pointer_interface, proxy_get_version(self.proxy), 0, nil);
	...
	id = proxy_marshal_flags(
                self.proxy,
		        1, &wl_keyboard_interface, proxy_get_version(self.proxy), 0, nil);
	...
	id = proxy_marshal_flags(
                self.proxy,
		        2, &wl_touch_interface, proxy_get_version(self.proxy), 0, nil);
    ...
    release := proc "c" (
        ...
        proxy_marshal_flags(
                self.proxy,
		        3, nil, proxy_get_version(self.proxy), WL_MARSHAL_FLAG_DESTROY);
...
create_wl_pointer :: proc "contextless" (proxy: ^wl_proxy) -> ^WlPointer {
    ...
    set_cursor := proc "c" (
        ...
        proxy_marshal_flags(
                self.proxy,
		        0, nil, proxy_get_version(self.proxy), 0, serial, surface, hotspot_x, hotspot_y);
...
create_wl_region :: proc "contextless" (proxy: ^wl_proxy) -> ^WlRegion {
    ...
    add := proc "c" (
        ...
        proxy_marshal_flags(
                self.proxy,
		        1, nil, proxy_get_version(self.proxy), 0, x, y, width, height);
...
create_wl_subcompositor :: proc "contextless" (proxy: ^wl_proxy) -> ^WlSubcompositor {
	...
	id = proxy_marshal_flags(
                self.proxy,
		        1, &wl_subsurface_interface, proxy_get_version(self.proxy), 0, nil, surface, parent);
...
create_wl_subsurface :: proc "contextless" (proxy: ^wl_proxy) -> ^WlSubsurface {
    ...
    set_position := proc "c" (
        ...
        proxy_marshal_flags(
                self.proxy,
		        1, nil, proxy_get_version(self.proxy), 0, x, y);
    ...
    place_above := proc "c" (
        ...
        proxy_marshal_flags(
                self.proxy,
		        2, nil, proxy_get_version(self.proxy), 0, sibling);
    ...
    place_below := proc "c" (
        ...
        proxy_marshal_flags(
                self.proxy,
		        3, nil, proxy_get_version(self.proxy), 0, sibling);
    ...
    set_sync := proc "c" (
        ...
        proxy_marshal_flags(
                self.proxy,
		        4, nil, proxy_get_version(self.proxy), 0);
    ...
    set_desync := proc "c" (
        ...
        proxy_marshal_flags(
                self.proxy,
		        5, nil, proxy_get_version(self.proxy), 0);
